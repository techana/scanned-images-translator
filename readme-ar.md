...
- **أفضل النتائج تأتي من جهاز Mac حديث.** محرك Vision في macOS (الافتراضي
  على macOS 15 فأحدث) يعتمد نماذج تعرّف عصبية من Apple مدرَّبة على صور
  ومسوحات واقعية، ويتفوّق بوضوح على Tesseract في الصفحات المطبوعة بنقاط
  الظل (halftone) — خاصةً اليابانية. وTesseract أيضًا عصبي (شبكات LSTM منذ
  الإصدار 4) وهو بديل محمول جيّد على Linux وWindows وإصدارات macOS الأقدم،
  لكن توقّع تعرّفًا أخشن على المسوحات المشوّشة، أي مزيدًا من التصحيح اليدوي
  في المحرر.
