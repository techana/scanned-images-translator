...
- **نسخ العناصر ولصقها** بالاختصارين ⌘C و⌘V (أو Ctrl على Linux وWindows).
  يعمل على مربع النص أو مستطيل الرقعة المحدَّد، وتحتفظ النسخة بكل شيء —
  النص والحجم والخط والألوان والمحاذاة — وتُوضَع حيث يشير مؤشر الفأرة.
  مفيد لتكرار نمط تعليق واحد عبر الصفحة.
- نتائج التعرف الضوئي والترجمة تُخزَّن لكل صفحة في `images_translator.cache/` — وتعديلاتك
